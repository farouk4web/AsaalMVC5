...
namespace Asaal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult UpdateProfile(UserProfileVM vm)
        {
            ...
            currentUser.FullName = vm.UpdateProfile.FullName;
            currentUser.CountryCode = vm.UpdateProfile.CountryCode;
            _context.SaveChanges();

            return RedirectToAction("UserProfile", "account", new { id = User.Identity.GetUserId(), infoState = true });
        }
        ...
        public ActionResult ChangeProfilePicture(HttpPostedFileBase profilePicture)
        {
            ...
            // store photo in cloudinary
            //upload the image to the files server
            ...
            var userPicture = new ImageUploadParams()
            {
                ...
                PublicId = "Asaal/Users/" + currentUserId,
            ...
            currentUser.ProfileImgSrc = userPictureResult.SecureUrl.AbsoluteUri;
            _context.SaveChanges();


            return RedirectToAction("UserProfile", "Account", new { id = currentUserId, photoState = true });
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangePassword(UserProfileVM vm)
        {
            if (!ModelState.IsValid)
                return RedirectToAction("UserProfile", "account", new { id = User.Identity.GetUserId(), changePasswordState = true });
